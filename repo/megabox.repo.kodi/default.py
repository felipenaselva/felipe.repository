...
base='http://kodimegabox.esy.es'
ADDON=xbmcaddon.Addon(id='megabox.repo.kodi')
...
def CATEGORIES():
    link = OPEN_URL('https://gist.githubusercontent.com/Gunboybr/2bbdcca92070b054aaa71260df88022a/raw/REPOSITORIOMEGABOX').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dialog.ok("Baixado com Sucesso:)", 'Para continuar a Instalacao irar ser solicitado que desligue o Kodi', 'Se for uma Box precione [COLOR yellow]NAO[/COLOR] e instale Todos addons a cima e Desligue o aparelho ou puxe-o da tomada sem sair do kodi se vc nao tem task kill.','[COLOR yellow][B][Kodi 17+][/B][/COLOR]Ao Voltar vai Addons em Meus Addons ativa o addons instalados.')
    killxbmc()
