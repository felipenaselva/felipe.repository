...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.kratosbr Lists-%s]: %s" %(addon_version, string))
        
lista = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/lista.xml").decode("utf-8"))
tube  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/tube.xml").decode("utf-8"))

play  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/play.m3u").decode("utf-8"))
mag  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/mag.xml").decode("utf-8"))
...
def web_conect():
    		...
    		f.write('\n <b> ***** Download de Lista Personalizadas do Kratos ***** </b><BR><BR>')
                ...
                f.write('\n<BR><BR>')
                f.write('\n <a href="http://kratos-addons-kodish.16mb.com/repo/instal/plugin.video.kractosbr/plugin.video.kractosbr-3.0.0.zip">Extraia o arquivo coloque as Listas na raiz </a><BR>')
...
def controle_lista():
	    ...
	    addDir('[COLOR white][B]APAGAR TODOS OS TORRENT [/COLOR][/B][COLOR green][B]KRATOS [/COLOR][COLOR yellow]KODI BR[/B][/COLOR]','117',105,icon,FANART,'','','','')
            addDir('','201',201,icon,FANART,'','','','')
            addDir('[COLOR white][B]REPRODUZIR UM VIDEO[/COLOR][/B]','114',114,icon,FANART,'','','','')
            addDir('','201',201,icon,FANART,'','','','')
            addDir('[COLOR white][B]LISTA TESTES[/COLOR][/B]','125',125,icon,FANART,'','','','')
...
def SKindex():
    ...
    addDir('[COLOR white][B]GERENCIAR LISTAS XML E M3U E YOUTUBE [/COLOR][/B][COLOR green][B]KRATOS [/COLOR][COLOR yellow]KODI BR[/B][/COLOR]','101',110,icon,FANART,'','','','')

    addDir('[COLOR white][B]PAREAMENTO CLICK AQUI [/COLOR][/B][COLOR green][B]KRATOS [/COLOR][COLOR yellow]KODI BR[/B][/COLOR]','104',104,icon,FANART,'','','','')
...
def GetSublinks(name,url,iconimage,fanart):
    ...
    if c==1:
		...
		if rNo>=0:
			...
			if 'emu://server01/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv11.ec.cx/RedeCanais/RedeCanais/RCServer01/videos/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server01on/' in rURL:
                            tam = len(rURL)
                            link = "http://v4.ec.cx/RedeCanais/RedeCanais/RCFServer1/ondemand/"+rURL[17:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server02/' in rURL:
                            tam = len(rURL)
                            link = "http://v4.ec.cx/RedeCanais/RedeCanais/RCFServer2/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server03/' in rURL:
                            tam = len(rURL)
                            link = "http://v3.ec.cx/RedeCanais/RCFServer3/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server04/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv18.ec.cx/RedeCanais/RedeCanais/RCFServer4/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server05/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv14.ec.cx/RedeCanais/RCServer05/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server06/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv10.ec.cx/RedeCanais/RedeCanais/RCServer06/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server07/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv10.ec.cx/RedeCanais/RedeCanais/RCServer07/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server08/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv15.ec.cx/RedeCanais/RCServer08/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server09/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv11.ec.cx/RedeCanais/RedeCanais/RCServer09/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server10/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv13.ec.cx/RedeCanais/RedeCanais/RCServer10/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server11/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv13.ec.cx/RedeCanais/RedeCanais/RCServer11/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server12/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv12.ec.cx/RedeCanais/RCServer12/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://server13/' in rURL:
                            tam = len(rURL)
                            link = "http://cdnv7.ec.cx/RedeCanais/RedeCanais/RCServer13/ondemand/"+rURL[15:tam]+""
                            xbmc.Player().play(link)
                        ...
                        if 'emu://netcine17/' in rURL:
                            tam = len(rURL)
                            link = "http://cdn1.ntcdn.us/content/httpdelivery/filmes2017/"+rURL[16:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://netcinedev/' in rURL:
                            tam = len(rURL)
                            link = "http://cdn1.ntcdn.us/content/httpdelivery/"+rURL[17:tam]+""
                            xbmc.Player().play(link)

                        if 'emu://netcinebucket/' in rURL:
                            tam = len(rURL)
                            link = "http://cdn1.ntcdn.us/content/sobdemanda/netcine-bucket/"+rURL[19:tam]+""
                            xbmc.Player().play(link)
...
#                    print 'item link', item('link')
                    ...
                    for i in item('server01'):
                        if not i.string == None:
                            server01 = 'http://cdnv11.ec.cx/RedeCanais/RedeCanais/RCServer01/videos/'+i.string+'.mp4'
                            url.append(server01)

                elif len(item('server01on')) >0:
                    for i in item('server01'):
                        if not i.string == None:
                            server01 = 'http://v4.ec.cx/RedeCanais/RedeCanais/RCFServer1/ondemand/'+i.string+'.mp4'
                            url.append(server01)
                    ...
                    for i in item('server03'):
                        if not i.string == None:
                            server03 = 'http://v3.ec.cx/RedeCanais/RCFServer3/ondemand/'+i.string+'.mp4'
                            url.append(server03)

                elif len(item('server02')) >0:
                    for i in item('server02'):
                        if not i.string == None:
                            server02 = 'http://v4.ec.cx/RedeCanais/RedeCanais/RCFServer2/ondemand/'+i.string+'.mp4'
                            url.append(server02)
                    ...
                    for i in item('server04'):
                        if not i.string == None:
                            server04 = 'http://cdnv18.ec.cx/RedeCanais/RedeCanais/RCFServer4/ondemand/'+i.string+'.mp4'
                            url.append(server04)
                    ...
                    for i in item('server05'):
                        if not i.string == None:
                            server05 = 'http://cdnv14.ec.cx/RedeCanais/RCServer05/ondemand/'+i.string+'.mp4'
                            url.append(server05)
							
                elif len(item('server06')) >0:
                    for i in item('server06'):
                        if not i.string == None:
                            server06 = 'http://cdnv10.ec.cx/RedeCanais/RedeCanais/RCServer06/ondemand/'+i.string+'.mp4'
                            url.append(server05)

                elif len(item('server07')) >0:
                    for i in item('server07'):
                        if not i.string == None:
                            server07 = 'http://cdnv10.ec.cx/RedeCanais/RedeCanais/RCServer07/ondemand/'+i.string+'.mp4'
                            url.append(server07)
                    ...
                    for i in item('server08'):
                        if not i.string == None:
                            server08 = 'http://cdnv15.ec.cx/RedeCanais/RCServer08/ondemand/'+i.string+'.mp4'
                            url.append(server08)
                            
                elif len(item('server09')) >0:
                    for i in item('server09'):
                        if not i.string == None:
                            server09 = 'http://cdnv11.ec.cx/RedeCanais/RedeCanais/RCServer09/ondemand/'+i.string+'.mp4'
                            url.append(server09)
                    ...
                    for i in item('server10'):
                        if not i.string == None:
                            server10 = 'http://cdnv13.ec.cx/RedeCanais/RedeCanais/RCServer10/ondemand/'+i.string+'.mp4'
                            url.append(server10)

                elif len(item('server11')) >0:
                    for i in item('server11'):
                        if not i.string == None:
                            server11 = 'http://cdnv13.ec.cx/RedeCanais/RedeCanais/RCServer11/ondemand/'+i.string+'.mp4'
                            url.append(server11)

                elif len(item('server12')) >0:
                    for i in item('server12'):
                        if not i.string == None:
                            server12 = 'http://cdnv12.ec.cx/RedeCanais/RCServer12/ondemand/'+i.string+'.mp4'
                            url.append(server12)
							
		elif len(item('server13')) >0:
                    for i in item('server13'):
                        if not i.string == None:
                            server13 = 'http://cdnv7.ec.cx/RedeCanais/RedeCanais/RCServer13/ondemand/'+i.string+'.mp4'
                            url.append(server13)
...
if mode==None:
    addon_log("Index")
    catdestroyer.check_crifer(__addon__,url)
    SKindex()	
    #teste()
elif mode==1:
    addon_log("getData")
