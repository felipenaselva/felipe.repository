...
playlistv = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/playlistv.xml").decode("utf-8"))
vaddon = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/vaddon.xml").decode("utf-8"))

m3u = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/lista.m3u").decode("utf-8"))
...
base = "XNjdzoFZSZ0L3Fmcv02bj5ibpJWZ0NXYw9yL6MHc0RHa"
tam = len(base)
basedem = base[::-1]
...
if base[0:4] == "XNjd":
    ...
    tp  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.kractosbr/resources/scripts/open.mp3").decode("utf-8"))
    xbmc.Player().play(tp)
...
def SKindex():
    ...
    addDir('[COLOR white][B]VIRTUAL ADDON [/COLOR][/B][COLOR green][B]KRATOS [/COLOR][COLOR yellow]KODI BR[/B][/COLOR]','501',501,icon2,FANART,'','','','')
