...
def CATEGORIES():
    if KODIVERSION >= 18.0:
        WIZARDURL = "https://pastebin.com/raw/6vSmSwzM"
    if KODIVERSION >= 17.0:
        WIZARDURL = "https://pastebin.com/raw/F4YhyH6e"
    elif KODIVERSION >= 16.0:
        WIZARDURL = "https://pastebin.com/raw/TcuQpfrf"
    else:
        WIZARDURL = "https://pastebin.com/raw/kfCRu1GY"
