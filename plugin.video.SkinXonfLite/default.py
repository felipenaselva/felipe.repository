...
base=''
ADDON=xbmcaddon.Addon(id='plugin.video.SkinXonfLite')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]SkinXonf Lite Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
