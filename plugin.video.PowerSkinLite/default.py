...
base=''
ADDON=xbmcaddon.Addon(id='plugin.video.PowerSkinLite')
...
def CATEGORIES():
    link = OPEN_URL('http://felipenaselva.pe.hu/build/powerskinlite.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]PowerSkin Lite Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
