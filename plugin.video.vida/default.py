...
addon = xbmcaddon.Addon(id='plugin.video.vida')
...
FANART = os.path.join(home, '2fanart.jpg')
...
base =  ''                                                                                                                                                                                                                                                                                                "FT3SGWZNPTLMH2FMEL2MXX4F2B4IH2BN"
tam = len(base)
basedem = base[::-1]
...
#                    print 'item link', item('link')
                ...
                elif len(item('vidatvf')) >0:
                    for i in item('vidatvf'):
                        if not i.string == None:
                            vidatvf = 'http://vidatvflix.xyz/'+i.string
                            url.append(vidatvf)							
