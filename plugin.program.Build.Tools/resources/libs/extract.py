...
def allWithProgress(_in, _out, dp, ignore, title):
	...
	for item in zin.infolist():
		...
		line2  = '[COLOR %s][B]Extraindo:[/B][/COLOR] [COLOR %s]%s Total de: %s[/COLOR] ' % (COLOR2, COLOR1, count, int(nFiles))
		line2 += '[COLOR %s][B]Extraido:[/B][/COLOR] [COLOR %s]%s de %s[/COLOR]' % (COLOR2, COLOR1, wiz.convertSize(size), zipsize)
