...
ADDONTITLE     = '[B][COLOR yellow]Assistente Build Tools[/COLOR][/B]'
BUILDERNAME    = 'Build Tools'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'repo.vikings', 'My_Builds', 'backupdir']
BUILDFILE      = 'https://pastebin.com/raw/KJLMP2mD'
UPDATECHECK    = 0
APKFILE        = 'http://'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Obrigado por usar o instalador.'
