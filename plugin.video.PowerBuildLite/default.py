...
base=''
ADDON=xbmcaddon.Addon(id='plugin.video.PowerBuildLite')
...
def CATEGORIES():
    link = OPEN_URL('http://seu.site11.com/all/build/powerbuildlite.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]Power Build Lite Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
