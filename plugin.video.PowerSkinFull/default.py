...
base=''
ADDON=xbmcaddon.Addon(id='plugin.video.PowerSkinFull')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.0"
PATH = "plugin.video.PowerSkinFull"            
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]PowerSkin Full Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
