...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        if lite == False:
            ...
            self.addDirectoryItem(32028, 'moviePeople', 'people-search.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem(32026, 'tvshows&url=exclusif', 'new-tvshows.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        ...
        #self.addDirectoryItem(32049, 'TviewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
        #self.addDirectoryItem(32050, 'FLIXNETclearSources', 'tools.png', 'DefaultAddonProgram.png')
        #self.addDirectoryItem(32052, 'FLIXNETclearCache', 'tools.png', 'DefaultAddonProgram.png')
        #self.addDirectoryItem(32073, 'FLIXNETinfoCheck', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
    ...
    def search(self):
        ...
        self.addDirectoryItem(32029, 'moviePeople', 'people-search.png', 'DefaultMovies.png')
        self.addDirectoryItem(32030, 'tvPeople', 'people-search.png', 'DefaultTVShows.png')
    ...
    def infoCheck(self, version):
        try:
            control.infoDialog('www.jesusboxmedia.tv', control.lang(32074).encode('utf-8'), time=5000, sound=False)
            return '1'
        except:
            return '1'
