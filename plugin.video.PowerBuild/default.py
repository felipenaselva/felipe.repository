...
base=''
ADDON=xbmcaddon.Addon(id='plugin.video.PowerBuild')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.0"
PATH = "plugin.video.PowerBuild"            

    
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/ou5jmywbd2eulj5/powerbuild.html?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]Power Build Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
    ...
    time.sleep(2)
    dp.update(0,"[COLOR=orange]EXTRAINDO ARQUIVOS[/COLOR]")
    print '======================================='
    print addonfolder
    print '======================================='
...
def killxbmc():
    choice = xbmcgui.Dialog().yesno('[COLOR=orange]DOWNLOAD CONCLUIDO[/COLOR]', 'Por favor, feche o Kodi para concluir a instalacao.', 'Clique em "Close" para fechar o Kodi.', nolabel='Return',yeslabel='Close')
    if choice == 0:
        return
    elif choice == 1:
        pass
